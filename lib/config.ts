...
// Limit research to materials from roughly the last N years. A couple of
// foundational facts (company founding & IPO date, education) are exempt — see
// lib/prompt.ts. Tighter window = less to research = faster.
export const RECENCY_YEARS = 3;
